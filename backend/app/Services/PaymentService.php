...
class PaymentService
{
    ...
    public function getReceiptData(Order $order): array
    {
        ...
        return [
            'store' => [
                'name'    => config('app.name', 'POS Delivery'),
                'address' => config('app.store_address', 'Jl. Contoh No. 1'),
                'phone'   => config('app.store_phone', '08123456789'),
            ],
            'order' => [
                'id'           => $order->id,
                ...
                'delivery_address' => $order->customer?->user->address ?? null,
            ...
            'payment' => [
                ...
                'amount_paid'  => (float) ($order->payment?->amount_paid ?? 0),
                'change_amount' => (float) ($order->payment?->change_amount ?? 0),
