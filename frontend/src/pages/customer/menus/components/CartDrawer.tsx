        ...
        <SheetHeader className="px-5 py-4 border-b border-border">
          <div className="flex items-center justify-between">
            <SheetTitle className="text-foreground flex items-center gap-2">
              ...
              Keranjang
              {items.length > 0 && (
                <span className="text-xs bg-accent text-accent-foreground font-bold px-1.5 py-0.5 rounded-full">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Button
                      size="icon"
                      className="w-6 h-6 bg-muted hover:bg-muted/90 text-foreground"
                    ...
                    <Button
                      size="icon"
                      className="w-6 h-6 bg-accent hover:bg-accent/90 text-accent-foreground"
                      onClick={() => updateQty(item.menu.id, item.qty + 1)}
                    >
                    ...
                    <Button
                      size="icon"
                      variant="ghost"
                      className="w-6 h-6 ml-auto text-muted-foreground hover:text-destructive hover:bg-transparent"
